...
print(f"HOST: {os.getenv('DB_HOST', 'mysql.hostinger.com')}")
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('DB_HOST', 'mysql.hostinger.com'),  # Using public hostname
...
# Enhanced logging for database issues
LOGGING = {
    'version': 1,
