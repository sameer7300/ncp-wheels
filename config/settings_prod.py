...
# Temporarily disable SSL redirect while certificate is being provisioned
...
# Comment out HSTS settings until SSL is ready
...
SECURE_SSL_CIPHERS = [
    ...
    # Add some older ciphers for compatibility
...
# Set minimum TLS version to 1.0 for broader compatibility
SECURE_MIN_TLS_VERSION = 'TLS1.0'
